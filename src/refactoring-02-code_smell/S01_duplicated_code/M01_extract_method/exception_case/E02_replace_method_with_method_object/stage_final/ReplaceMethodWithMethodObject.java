package S01_duplicated_code.M01_extract_method.exception_case.E02_replace_method_with_method_object.stage_final;
 ...
 * 抽出的 方法对象 Gamma
 * 如果只是在当前的类中使用
 * 我们可以将 Gamma 作为当前类的内部类
 * 这样 Gamma 类中就不用再维护当前类 ReplaceMethodWithMethodObject 的对象了
 *
 */
class Gamma {
